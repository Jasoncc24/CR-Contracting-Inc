module.exports = {
  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        geometric: "url('/src/assets/img/hero/bg.svg')",
        abstract: "url('/src/assets/img/abstract.svg')",
        pedal: "url('/src/assets/img/pedal.svg')",
        cardsBg: "url('/src/assets/img/cards/bg.png')",
        video: "url('/src/assets/img/video/video.png')",
        contact: "url('/src/assets/img/contact/bg.png')",
        building: "url('/src/assets/img/modern.png')",
      },
      boxShadow: {
